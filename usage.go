...
type MachineComputeUsage struct {
	...
	Rows []MachineComputeUsageRow `json:"rows" api:"required"`
...
func (r MachineComputeUsage) RawJSON() string { return r.JSON.raw }
func (r *MachineComputeUsage) UnmarshalJSON(data []byte) error {
...
// Returns the unmodified JSON received from the API
func (r MachineComputeUsageRow) RawJSON() string { return r.JSON.raw }
func (r *MachineComputeUsageRow) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
...
type MachineStorageUsage struct {
	...
	Rows []MachineStorageUsageRow `json:"rows" api:"required"`
	// JSON contains metadata for fields, check presence with [respjson.Field.Valid].
	JSON struct {
		PeriodEnd   respjson.Field
		PeriodStart respjson.Field
...
// Returns the unmodified JSON received from the API
func (r MachineStorageUsageRow) RawJSON() string { return r.JSON.raw }
func (r *MachineStorageUsageRow) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
...
// URLQuery serializes [UsageMachineComputeParams]'s query parameters as
// `url.Values`.
func (r UsageMachineComputeParams) URLQuery() (v url.Values, err error) {
	return apiquery.MarshalWithSettings(r, apiquery.QuerySettings{
		ArrayFormat:  apiquery.ArrayQueryFormatRepeat,
		NestedFormat: apiquery.NestedQueryFormatBrackets,
	})
...
// URLQuery serializes [UsageMachineStorageParams]'s query parameters as
// `url.Values`.
func (r UsageMachineStorageParams) URLQuery() (v url.Values, err error) {
	return apiquery.MarshalWithSettings(r, apiquery.QuerySettings{
		ArrayFormat:  apiquery.ArrayQueryFormatRepeat,
		NestedFormat: apiquery.NestedQueryFormatBrackets,
	})
