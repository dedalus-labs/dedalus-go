...
// List terminals
func (r *WorkspaceTerminalService) List(ctx context.Context, workspaceID string, query WorkspaceTerminalListParams, opts ...option.RequestOption) (res *pagination.TerminalList[Terminal], err error) {
...
// List terminals
func (r *WorkspaceTerminalService) ListAutoPaging(ctx context.Context, workspaceID string, query WorkspaceTerminalListParams, opts ...option.RequestOption) *pagination.TerminalListAutoPager[Terminal] {
	return pagination.NewTerminalListAutoPager(r.List(ctx, workspaceID, query, opts...))
}
